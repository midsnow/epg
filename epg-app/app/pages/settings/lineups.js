...
export default class Lineup extends React.Component {
	constructor(props) {
		...
		this.state = {
			parent: props,
			slideIndex: pageIndex[this.props.params.action] ?  pageIndex[this.props.params.action] : 0,
			pageIndex: pageIndex,
			ready: false,
			durationError:2000,
			...
			lineupMap: {},
			stationsTable: this.props.params.action === 'stations' ? true : false,
			newconfirm: {
				open: false
			},
		}
	...
	render() {
		...
		let headend = this.props.headends[this.props.params.station];
		...
		if(!this.props.headends) {
			...
			return (<Col xs={12} className="no-padding" >
						...
						>
							...
							<Tab label={<div style={ { position:'relative', width: '100%' } }>
								Channels 
								<div style={{display: this.state.slideIndex === 1 ? 'block':'none', position:'absolute',top:'-15',right:'25'}}>
									<IconMenu 
										iconButtonElement={<IconButton><FontIcon className="material-icons" color={Styles.Colors.limeA400} hoverColor={Styles.Colors.greenA200} >cached</FontIcon></IconButton>}
									>
						...
						>
										...
										<CardText style={{}} >
											<List>
												...
												<ListItem 
													...
													primaryText="Delete" 
													style={{color:Styles.Colors.deepOrange800}}
													leftIcon={
														<Icons 
															name="trash"  
															style={{color:Styles.Colors.deepOrange800}}
													...
													onClick={()=>{this.props.lineupRemove(headend)}}
												/>
											</List>
							...
							<div id="channels" className="no-gutter" style={styles.slide}>
									<CardTitle 
										...
										subtitleColor={Styles.Colors.blue300}
									/>
							...
							<div style={styles.slide}>
									...
									/>
									<CardText style={{padding:0}} >
										<Col xs={6}><Button className={"left"} ref="schedules" onClick={e => this.getSchedules()} durationSuccess={this.state.durationSuccess} durationError={this.state.durationError} >Add Group</Button>
										</Col>
